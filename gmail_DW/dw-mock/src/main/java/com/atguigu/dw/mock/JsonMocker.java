package com.atguigu.dw.mock;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.atguigu.dw.mock.util.*;
...
public class JsonMocker {
    ...
    RandomOptGroup<Boolean>  isQuitGroup= new RandomOptGroup(quitOpts);
    ...
    String initStartupLog( ){
     ...
     `area` string COMMENT '城市' */
        ...
        String mid= "mid_"+ RandomNum.getRandInt(500,750);
